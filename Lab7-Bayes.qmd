...
-   What are the 95% CIs for the difference between high and low power pose groups? Plot them using the `bayestestR` function `hdi (https://easystats.github.io/bayestestR/reference/hdi.html)`
